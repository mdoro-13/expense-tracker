        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Color = table.Column<string>(type: "character(6)", fixedLength: true, maxLength: 6, nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SpendingLimits_Budgets_BudgetId",
                        column: x => x.BudgetId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpendingLimits_BudgetId",
